(ns br.hooks.tipos_propiedad
  "Business logic hooks for tipos_propiedad entity.
...
(defn before-load
  ...
  (println "[INFO] Loading tipos_propiedad with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "tipos_propiedad record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving tipos_propiedad...")
...
(defn after-save
  ...
  (println "[INFO] Tipos_propiedad saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if tipos_propiedad can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Tipos_propiedad deleted successfully. ID:" entity-id)
  {:success true})
