(ns br.hooks.pagos
  "Business logic hooks for pagos entity.
...
(defn before-load
  ...
  (println "[INFO] Loading pagos with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "pagos record(s)")
...
(defn after-save
  ...
  (println "[INFO] Pagos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if pagos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Pagos deleted successfully. ID:" entity-id)
  {:success true})
