(defproject br "0.1.0"
  ...
  :aliases {"migrate"  ["run" "-m" "br.migrations/migrate" "--"]
            "rollback" ["run" "-m" "br.migrations/rollback" "--"]
            ...
            "database" ["run" "-m" "br.models.cdb/database" "--"]
            "scaffold" ["run" "-m" "br.engine.scaffold"]
            ...
            "convert-migrations" ["run" "-m" "br.db.converter" "--"]
            ...
            "gen-handler" ["run" "-m" "br.gen.handler" "--"]}
