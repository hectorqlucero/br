...
(defn before-load
  ...
  (println "[INFO] Loading rentas with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "rentas record(s)")
...
(defn before-delete
  ...
  (println "[INFO] Checking if rentas can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Rentas deleted successfully. ID:" entity-id)
  {:success true})
