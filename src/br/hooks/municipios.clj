...
(defn before-load
  ...
  (println "[INFO] Loading municipios with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "municipios record(s)")
...
(defn after-save
  ...
  (println "[INFO] Municipios saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if municipios can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Municipios deleted successfully. ID:" entity-id)
  {:success true})
