...
This creates `resources/entities/products.edn`, migration files, and `src/br/hooks/products.clj`. Refresh the browser and the entity appears in the menu.
...
```bash
lein uberjar
java -jar target/uberjar/br-0.1.0-standalone.jar
```
