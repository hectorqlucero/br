(ns br.hooks.avaluos
  "Business logic hooks for avaluos entity.
...
(defn before-load
  ...
  (println "[INFO] Loading avaluos with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "avaluos record(s)")
...
(defn after-save
  ...
  (println "[INFO] Avaluos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if avaluos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Avaluos deleted successfully. ID:" entity-id)
  {:success true})
