(ns br.hooks.documentos
  "Business logic hooks for documentos entity.
...
(defn before-load
  ...
  (println "[INFO] Loading documentos with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "documentos record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving documentos...")
...
(defn after-save
  ...
  (println "[INFO] Documentos saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if documentos can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Documentos deleted successfully. ID:" entity-id)
  {:success true})
