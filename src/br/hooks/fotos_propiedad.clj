(ns br.hooks.fotos_propiedad
  "Business logic hooks for fotos_propiedad entity.
...
(defn before-load
  ...
  (println "[INFO] Loading fotos_propiedad with params:" params)
  params)
...
(defn after-load
  ...
  [rows params]
  (println "[INFO] Loaded" (count rows) "fotos_propiedad record(s)")
...
(defn before-save
  ...
  [params]
  (println "[INFO] Saving fotos_propiedad...")
...
(defn after-save
  ...
  (println "[INFO] Fotos_propiedad saved successfully. ID:" entity-id)
  {:success true})
...
(defn before-delete
  ...
  (println "[INFO] Checking if fotos_propiedad can be deleted. ID:" entity-id)
  {:success true})
...
(defn after-delete
  ...
  (println "[INFO] Fotos_propiedad deleted successfully. ID:" entity-id)
  {:success true})
