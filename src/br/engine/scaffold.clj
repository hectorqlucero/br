...
(defn generate-hook-stub
  ...
  (let [file-fields (filter #(= :file (:type %)) fields)
    ...
    (str "(ns br.hooks." entity-name "\n"
       ...
       (when has-file-fields? "\n  (:require [br.models.util :refer [image-link]])") ")\n"
       "\n"
       ";; =============================================================================\n"
       ";; Validators\n"
       ";; =============================================================================\n"
...
(defn generate-edn-content
  ...
  (let [entity-name (name (:entity config))
    ...
    (str ";; AUTO-GENERATED entity configuration for " (:table config) "\n"
         ...
         " ;; :hooks {:before-load :br.hooks." entity-name "/before-load\n"
         " ;;         :after-load :br.hooks." entity-name "/after-load\n"
         " ;;         :before-save :br.hooks." entity-name "/before-save\n"
         " ;;         :after-save :br.hooks." entity-name "/after-save\n"
         " ;;         :before-delete :br.hooks." entity-name "/before-delete\n"
         " ;;         :after-delete :br.hooks." entity-name "/after-delete}\n"
