...
- `src/br/hooks/products.clj` - Hook stub file (for senior)
...
Edit `src/br/hooks/products.clj`:

```clojure
(ns br.hooks.products
...
{:entity :products
 ...
 ;; UNCOMMENT THIS:
 :hooks {:before-save :br.hooks.products/before-save
         :after-save :br.hooks.products/after-save}}
```
...
3. **Implement Hooks** in `src/br/hooks/`
...
2. Namespace is correct (:br.hooks.products/before-save)
