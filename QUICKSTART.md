...
- Hook file: `src/br/hooks/products.clj`
...
{:id :category_id
 :label "Category"
 :type :select
 :options :br.models.lookups/get-categories}
```
...
{:id :total
 :label "Total"
 :type :computed
 :compute-fn :br.hooks.orders/calculate-total}
```
...
;; In entity config
{:id :price
 :validation :br.validators.products/positive-price?}
```
...
Create hooks in `src/br/hooks/`

### 6. Customize UI (if needed)
Create custom renderers in `src/br/views/`
